...
class Funciones {
    public static $DIRECTORIO_PRINCIPAL = "tecnologo";
    ...
    public static function generarHTMLReporte($htmlDatos) {
        $html = '
                    <html>
                        <head>
                            <meta charset="utf-8">
                            <link rel="stylesheet" href="'.$_SERVER["HTTP_ORIGIN"].'/'.Funciones::$DIRECTORIO_PRINCIPAL.'/D22_comercial/vista/css/reporte.css"/>
                        </head>
                        <body>';
