                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3" align="center" ><!--Iniio de Columna-->
                            <div>
                                <img src="../util/imagenes/2.jpg"  class="img-circle" alt="User Image">
                            </div>
                            <div>
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <label>Nombres: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>   
                                <input type="text"  style="border-style:hidden" id="txtnomb"  name="txtnomb" value="<?php echo $nombreUsuario;?>" readonly=""/>
                            </div>
                            <div class="form-group">
                                <label>Usuario: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
                                <input type="text"   style="border-style:hidden" id="txtusuario"  name="txtusuario" value="<?php echo $cuenta;?>"  readonly=""/>
                            </div>
                            <div class="form-group">
                                <label>Clave Antigua: &nbsp;&nbsp;</label>
                                <input type="password"   style="border-style: dotted" id="txtclaveantigua"  name="txtclaveantigua"  required=""/>
                            </div>
                            <div class="form-group">
                                <label>Clave Nueva: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input type="password"   style="border-style: dotted" id="txtclavenueva"  name="txtclavenueva"   required=""/>
                            </div>
                            <div class="form-group">
                                <label>Repita Clave: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input type="password"   style="border-style: dotted" id="txtclaverepetida"  name="txtclaverepetida"   required=""/>
                            </div>
                            <div class="form-group">
