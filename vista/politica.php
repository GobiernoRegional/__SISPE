        ...
        <div class="container">
        	...
        	<div class="row">
               <div style="text-align:center;">
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="display: inline-block;"><i class="fa fa-file-archive-o"></i></a>
                </div>
                <div style="text-align:center;">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="titulomodal">Agregar nueva Política</h4>
                      </div>
                ...
                <div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="titulomodal">Editar Politica</h4>
                      </div>
                      <div class="modal-body">
                          <div class="row">
            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table" id="tablepolitica">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Sector</th>
