...
<html>
        ...
        <div class="container">
        	...
        	<div class="row">
               <div style="text-align:center;">
                ...
                <div style="text-align:center;">
                    <label style="display: inline-block; font-size:16px; margin-top: 10px; margin-bottom: 20px;">Agregar Estrategias</label>
                </div>
            </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="titulomodal">Agregar nueva Estrategia</h4>
                      </div>
                      <div class="modal-body">                         
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                  <select class="form-control" name="txtpolitica" id="txtpolitica">
                                    <option value="0">Elegir Política</option>
                                  </select><br>
                              </div>
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-8">
                                  <textarea type="text" class="form-control" name="txtestrategia" id="txtestrategia" onchange="camposMayus(this)" required></textarea><br>
                              </div>
                          </div>
                      </div>
                ...
                <div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="titulomodal">Editar Estrategia</h4>
                      </div>
                      <div class="modal-body">
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                  <select class="form-control" name="txtpoliticaedit" id="txtpoliticaedit">
                                    <option value="0">Elegir Política</option>
                                  </select><br>
                              </div>
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-8">
                                  <textarea type="text" class="form-control" name="txtestrategiaedit" id="txtestrategiaedit" onchange="camposMayus(this)" required></textarea><br>
                              </div>
                          </div>
                      </div>
                      <div class="modal-footer">
            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table" id="tableestrategia">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Política</th>
    ...
    <!-- JS Propio -->
    <script type="text/javascript" src="js/prEstrategias.js"></script>
  </body>
</html>