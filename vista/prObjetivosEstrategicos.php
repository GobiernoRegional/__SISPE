...
<html>
        ...
        <div class="container">
        	...
        	<div class="row">
               <div style="text-align:center;">
                ...
                <div style="text-align:center;">
                    <label style="display: inline-block; font-size:16px; margin-top: 10px; margin-bottom: 20px;">Agregar Objetivo Estratégico</label>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                <textarea type="text" class="form-control" name="txtobjetivo" id="txtobjetivo" onchange="camposMayus(this)"></textarea><br>
                              </div>
                          </div>
                      </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                <textarea type="text" class="form-control" name="txtobjetivoedit" id="txtobjetivoedit" onchange="camposMayus(this)"></textarea><br>
                              </div>
                          </div>
                      </div>
                      <div class="modal-footer">
            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table" id="tableobjetivoestrategico">
                        <thead>
                            <tr>
                                <th>Código</th>
                        ...
                        <tbody id="bodyobjetivoestrategico">
    ...
    <!-- JS Propio -->
    <script type="text/javascript" src="js/prObjetivoEstrategico.js"></script>
  </body>
</html>