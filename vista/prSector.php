        ...
        <div class="container">
        	...
        	<div class="row">
               <div style="text-align:center;">
                ...
                <div style="text-align:center;">
                    <label style="display: inline-block; font-size:16px; margin-top: 10px; margin-bottom: 20px;">Agregar Sector</label>
                </div>
            </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="titulomodal">Agregar nuevo sector</h4>
                      </div>
                ...
                <div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="titulomodal">Editar sector</h4>
                      </div>
                      <div class="modal-body">
                          <div class="row">
            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table" id="tablesector">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Sector</th>
